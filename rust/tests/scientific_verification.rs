...
fn symbol_map_roi_positive_for_frequent_long_idents() {
    use better_ctx::core::symbol_map::should_register;
    assert!(
...
fn symbol_map_net_savings_correct() {
    use better_ctx::core::symbol_map::SymbolMap;
...
fn ib_filter_preserves_task_relevant_lines() {
    use better_ctx::core::task_relevance::information_bottleneck_filter;
...
fn ib_filter_reduces_more_for_repetitive_content() {
    use better_ctx::core::task_relevance::{adaptive_ib_budget, information_bottleneck_filter};
...
fn safeguard_prevents_over_compression() {
    use better_ctx::core::compressor::safeguard_ratio;
...
fn cost_model_token_savings_exclude_output_bonus() {
    let summary = better_ctx::core::stats::load_stats();
