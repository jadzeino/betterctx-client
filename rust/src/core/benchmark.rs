...
pub fn format_terminal(b: &ProjectBenchmark) -> String {
    ...
    out.push(format!("  better-ctx Benchmark — {}", b.root));
    out.push(sep.to_string());
...
pub fn format_markdown(b: &ProjectBenchmark) -> String {
    ...
    out.push("# better-ctx Benchmark Report".to_string());
    out.push(String::new());
    ...
    out.push(String::new());
    out.push(format!(
        "*Generated by better-ctx benchmark v{} — https://betterctx.com*",
