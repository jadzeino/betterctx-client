...
impl Mailer {
    ...
    pub async fn send_verification(&self, to_email: &str, link: &str) -> anyhow::Result<()> {
        ...
        let email = Message::builder()
            ...
            .to(to)
            .subject("Verify your betterCTX account")
            .body(format!(
                "Welcome to betterCTX!\n\nPlease verify your email address:\n\n{link}\n\nThis link expires in 24 hours."
            ))?;
    ...
    pub async fn send_password_reset(&self, to_email: &str, link: &str) -> anyhow::Result<()> {
        ...
        let email = Message::builder()
            .from(self.from.clone())
            .to(to)
            .subject("Reset your betterCTX password")
            .body(format!(
                "You requested a password reset for your betterCTX account.\n\nClick to reset your password:\n\n{link}\n\nThis link expires in 1 hour.\nIf you didn't request this, ignore this email."
            ))?;
        self.transport.send(email).await?;
        Ok(())
    }
